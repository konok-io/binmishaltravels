export const ar = {
  ...
  bangladesh: 'بنغلاديش',
  manageYourBranches: 'إدارة فروعك',
  totalBranches: 'إجمالي الفروع',
  noBranches: 'لا توجد فروع',
  noBranchesDesc: 'أضف أول فرع للبدء',
  addFirstBranch: 'أضف أول فرع',
  deleteBranchConfirm: 'هل أنت متأكد من حذف هذا الفرع؟ لا يمكن التراجع عن هذا الإجراء.',
  accessDenied: 'تم رفض الوصول',
  onlySuperAdminCanAccess: 'فقط المشرف العام يمكنه الوصول إلى هذه الصفحة',
  ...
  completed: 'مكتمل',
  cancelled: 'ملغى',
  createNewTransaction: 'إنشاء معاملة خدمة جديدة',
  selectService: 'اختر الخدمة',
  serviceCategory: 'فئة الخدمة',
  change: 'تغيير',
  customerInfo: 'معلومات العميل',
  paymentInfo: 'معلومات الدفع',
  searchCustomerByName: 'البحث عن عميل',
  ...
  lastVisit: 'آخر زيارة',
  manageYourCustomers: 'إدارة جميع عملائك',
  searchCustomer: 'البحث بالاسم أو الهاتف أو الرقم',
  noCustomers: 'لا يوجد عملاء',
  noCustomersDesc: 'لا يوجد عملاء يطابقون معاييرك',
  addFirstCustomer: 'أضف أول عميل',
  avgSpentPerCustomer: 'متوسط الصرف لكل عميل',
  deleteCustomer: 'حذف العميل',
  deleteCustomerConfirm: 'هل أنت متأكد من حذف هذا العميل؟ لا يمكن التراجع عن هذا الإجراء.',
  addNewCustomerDesc: 'املأ معلومات العميل أدناه',
  ...
  active: 'نشط',
  inactive: 'غير نشط',
  manageYourUsers: 'إدارة المستخدمين',
  searchUser: 'البحث بالاسم أو البريد أو الهاتف',
  allRoles: 'جميع الأدوار',
  noUsers: 'لا يوجد مستخدمون',
  noUsersDesc: 'أضف أول مستخدم للبدء',
